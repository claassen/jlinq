...
public class JLinqBaseTest {
    ...
    private List<TestClass> items = Arrays.asList(
        new TestClass(1, 2),
        new TestClass(2, 4),
        new TestClass(3, 6)
    );
    ...
    public void testReduce() {
        ...
        assertThat(base.reduce(0, (memo, item) -> memo + item.getX()), equalTo(6));
        assertThat(base.reduce(1, (memo, item) -> memo + item.getX()), equalTo(7));
        assertThat(base.reduce(0, (memo, item) -> memo + item.getY()), equalTo(12));
        assertThat(base.reduce(1, (memo, item) -> memo + item.getY()), equalTo(13));
    }
